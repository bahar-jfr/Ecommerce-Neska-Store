...
export const productSchema = yup.object().shape({
  ...
  description: yup
    ...
    category: yup.string().required( `${localization.category} ${pageLevelLocalization.productsData.choose}`).label("Category"),
  subcategory: yup.string().required( `${localization.subcategory} ${pageLevelLocalization.productsData.choose}`).label("Subcategory"),
});
