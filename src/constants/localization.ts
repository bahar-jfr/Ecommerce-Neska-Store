...
export const pageLevelLocalization = {
  ...
  home:{
    ...
    brandsDescription:{
      starbucks:"قهوه مورد علاقه جهان را با طیف گسترده ای از ترکیب ها و طعم ها که به طرز ماهرانه ای برای گرد هم آوردن مردم ساخته شده است، تجربه کنید.",
      nescafe:"روز خود را با یک تجربه قهوه غنی و روان، از برند قهوه پیشرو در جهان، با میراثی از کیفیت و نوآوری آغاز کنید.",
      fitness: "سبک زندگی فعال خود را با رویکردی متعادل و مغذی، از طریق طیف وسیعی از محصولات الهام گرفته از تناسب اندام ما که برای حمایت از اهداف سلامتی شما طراحی شده اند، تقویت کنید."
    },
